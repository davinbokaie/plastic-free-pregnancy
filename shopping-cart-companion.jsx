...
const CATEGORIES = [
  ...
  },
  {
    ...
    footnote: "* PFAS-free is not always labeled — when in doubt, choose cotton or wool fabric.",
  },
];
...
function CoverPage({ onStart }) {
  return (
    <div style={{
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700&family=DM+Serif+Display&family=Source+Serif+4:ital,opsz,wght@0,8..60,300;0,8..60,400;0,8..60,600;1,8..60,400&display=swap');
      ...
      <div style={{
        ...
        <div style={{
          ...
          gap: 6,
          padding: "10px 20px",
          backgroundColor: "#5B7E5F18",
          borderRadius: 100,
          marginBottom: 44,
          animation: "fadeUp 0.6s ease 0.3s both",
        }}>
          <span style={{ fontSize: 14, fontWeight: 600, color: "#5B7E5F", letterSpacing: "0.03em" }}>
        ...
        <button
          ...
          onMouseLeave={e => e.target.style.backgroundColor = "#5B7E5F"}
        >
          Open →
        </button>
      </div>
...
function CategoryPage({ category, index, total, onNext, onPrev, onHome }) {
  ...
  return (
    <div style={{
      ...
      {/* Content */}
      <div style={{ flex: 1, padding: "28px 28px 110px", maxWidth: 680, margin: "0 auto", width: "100%" }}>

        {/* Category header */}
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: category.subtitle ? 6 : 0 }}>
            <span style={{ fontSize: 40, lineHeight: 1, flexShrink: 0 }}>{category.emoji}</span>
            <h2 style={{
              margin: 0,
              fontSize: 32,
              fontWeight: 700,
...
export default function ShoppingCartCompanion() {
  const [page, setPage] = useState("cover"); // "cover" | number
